...
<Info>
  **Launch Timeline:** Go live in 2 weeks with our white-label solution
</Info>

## What's Included

<CardGroup cols={2}>
  <Card title="Virtual Accounts & Wallets" icon="wallet">
  ...
  <Card title="Payouts & Collections" icon="money-bill-transfer">
...
### Revenue Share
Share transaction fees with Fossapay based on volume:
- **Starter**: 70/30 split (You keep 70%)
- **Growth**: 80/20 split
- **Enterprise**: Custom rates

### Platform Fee
Fixed monthly platform fee + lower transaction costs:
- **Basic**: ₦500,000/month
- **Professional**: ₦1,500,000/month
...
<AccordionGroup>
  <Accordion title="Digital Bank - 100K Users in 6 Months">
    A consumer neobank launched with Fossapay's white-label solution and acquired 100,000 users in their first 6 months, processing over ₦5 billion in transactions.
  </Accordion>

  <Accordion title="Freelancer Platform - Instant Payouts">
    A gig economy platform integrated Fossapay to offer instant wallet-to-bank payouts, reducing payout time from 7 days to instant and improving freelancer retention by 40%.
  </Accordion>

  <Accordion title="Crypto Exchange - Fiat Gateway">
    A cryptocurrency exchange used Fossapay to build NGN on/off ramps, enabling customers to buy crypto with naira transfers and sell crypto to their bank accounts.
  </Accordion>
</AccordionGroup>

## Feature Comparison

| Feature | DIY Banking License | Fossapay White-Label |
|---------|---------------------|----------------------|
| Time to Market | 12-24 months | 2 weeks |
| Upfront Cost | ₦100M+ | ₦0 |
| Banking License | Required | Not required |
| Compliance Team | Build in-house | Included |
| Infrastructure | Build & maintain | Fully managed |
| API Integration | N/A | ✅ Simple REST API |

## Regulatory Benefits

By using Fossapay's white-label solution:
- ✅ No need for your own banking license
...
<CardGroup cols={2}>
  ...
  <Card title="Customization" icon="palette" href="/white-label/customization">
    Customize your branding and features
  </Card>
  <Card title="Contact Sales" icon="phone" href="mailto:sales@fossapay.com">
    Schedule a consultation
  </Card>
  <Card title="View Demo" icon="display" href="https://demo.fossapay.com">
    See a live demo
  </Card>
</CardGroup>
...
- **Email**: sales@fossapay.com
- **Phone**: +234 (0) 800 FOSSAPAY
- **Schedule**: [Book a demo](https://calendly.com/fossapay/demo)
