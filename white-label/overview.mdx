...
<CardGroup cols={2}>
  ...
  <Card color="#0080FF" title="Developer Support" icon="code">
    Dedicated technical support and production onboarding
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Technical Integration">
    Our team helps you integrate the APIs and prepare your production environment
  </Step>
  ...
  <Step title="Testing & QA">
    Test all features against production with our support using small live transactions
  </Step>
...
- **Phone**: +2347088899861
- **Schedule**: [Book a demo](https://calendly.com/fossapay/30min)
