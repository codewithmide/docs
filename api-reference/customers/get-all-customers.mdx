...
api: 'GET https://api-production.fossapay.com/api/v1/customers'
...
```javascript
const response = await fetch('https://api-production.fossapay.com/api/v1/customers?sortOrder=desc&sortBy=createdAt&search=john&page=1&limit=10', {
  method: 'GET',
  headers: {
