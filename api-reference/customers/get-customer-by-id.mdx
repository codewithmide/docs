...
api: 'GET https://api-production.fossapay.com/api/v1/customers/{customerId}'
...
const response = await fetch(`https://api-production.fossapay.com/api/v1/customers/${customerId}`, {
  method: 'GET',
  headers: {
