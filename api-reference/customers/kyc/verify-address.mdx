...
api: 'POST https://api-production.fossapay.com/v1/customers/kyc/address'
...
```javascript
const response = await fetch('https://api-production.fossapay.com/v1/customers/kyc/address', {
  method: 'POST',
  headers: {
