...
api: 'GET https://api-staging.fossapay.com/api/v1/wallets/{wallet_id}/balance'
...
```bash
curl "https://api-staging.fossapay.com/api/v1/wallets/wal_abc123/balance?currency=NGN" \
