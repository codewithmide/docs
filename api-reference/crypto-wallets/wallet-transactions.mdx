...
api: 'GET https://api-production.fossapay.com/api/v1/wallets/crypto/{walletId}/transactions'
...
```bash
curl -X GET "https://api-production.fossapay.com/api/v1/wallets/crypto/user:u3d/transactions?page=1&limit=10&transactionType=DEPOSIT" \
  -H "x-api-key: your_api_key_here"
```

```javascript
const url = new URL(
  'https://api-production.fossapay.com/api/v1/wallets/crypto/user:u3d/transactions'
);
