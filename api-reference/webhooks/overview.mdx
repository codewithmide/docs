...
```bash
curl -X PUT https://api-staging.fossapay.com/v1/settings/webhooks \
...
<CardGroup cols={2}>
  <Card title="Webhook Events" href="/api-reference/webhooks/events">
    View all available webhook events
  </Card>
  <Card title="Webhooks Concept" href="/concepts/webhooks">
