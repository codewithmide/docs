---
title: 'Get Master Fiat Wallet'
api: 'GET /api/v1/wallets/fiat/master'
description: "Retrieve the merchant's master fiat wallet, including live balance and virtual account details"
---
...
<ResponseField name="data" type="object">
  <Expandable title="properties">
    ...
    <ResponseField name="merchantId" type="string">
      ID of the merchant that owns the wallet
    </ResponseField>
