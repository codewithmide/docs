...
Please note that each CLI release is associated with a specific version of Mintlify. If your local preview does not align with the production version, update the CLI:
...
<AccordionGroup>
  ...
  This may be due to an outdated version of Node.js. Try the following:
    1. Remove the currently-installed version of the CLI: `npm uninstall -g mint`
