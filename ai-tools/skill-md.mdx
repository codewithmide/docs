...
```
Generate code to create a customer and NGN wallet using the FossaPay API
```
...
// 2. Create a NGN wallet for collections
...
| NGN Wallets | Create wallets, check balances, view transactions |
| NGN Transfers | Send to banks, verify accounts, calculate fees |
...
<Tip>
  **Be specific** - Instead of "help with payments", try "generate code to create an NGN wallet and handle the deposit webhook in Python"
</Tip>
