...
<CardGroup cols={2}>
  <Card color="#0080FF" title="Configure Webhooks" icon="gear" href="https://dashboard.fossapay.com/settings/webhooks">
    Set up your webhook endpoint
  </Card>
  <Card color="#0080FF" title="View Webhook Logs" icon="list" href="https://dashboard.fossapay.com/webhooks/logs">
