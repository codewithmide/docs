...
| Transfer type | Use when | Fee |
|---|---|---|
| [Wallet-to-Wallet Transfer](/api-reference/virtual-account/wallet-transfer) | The sender and recipient are both FossaPay customers under the same business | Free |
| [Inter-Bank Transfer](/api-reference/fiat-transfers/inter-bank-transfer) | The recipient uses an account at another supported Nigerian bank | Calculate the applicable fee before sending |
...
<CardGroup cols={2}>
  <Card color="#07C983" title="Wallet-to-Wallet Transfer" icon="wallet" href="/api-reference/virtual-account/wallet-transfer">
    Free transfers between two customers under your business
  </Card>
  <Card color="#0080FF" title="Inter-Bank Transfer" icon="building-columns" href="/api-reference/fiat-transfers/inter-bank-transfer">
