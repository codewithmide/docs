...
<CardGroup cols={2}>
  <Card color="#0080FF" title="Create Fiat Wallet API" icon="code" href="/api-reference/virtual-account/create-wallet">
  ...
  <Card color="#0080FF" title="Reconciliation Guide" icon="book" href="/guides/reconciliation">
