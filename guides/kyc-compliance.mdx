...
<CardGroup cols={2}>
  <Card title="Create Customer" icon="code" href="/api-reference/customers/create-customer">
    Create customers before KYC verification
  </Card>
  <Card title="BVN Verification API" icon="code" href="/api-reference/customers/kyc/verify-bvn">
    Verify customer BVN
  </Card>
  <Card title="NIN Verification API" icon="code" href="/api-reference/customers/kyc/verify-nin">
    Verify customer NIN
  </Card>
  <Card title="Address Verification API" icon="code" href="/api-reference/customers/kyc/verify-address">
