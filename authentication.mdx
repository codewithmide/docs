...
```bash
curl https://api-staging.fossapay.com/v1/virtual-accounts \
...
const response = await axios.post(
  'https://api-staging.fossapay.com/v1/virtual-accounts',
  {
...
```bash
curl https://api-staging.fossapay.com/v1/auth/test \
  -H "Authorization: Bearer YOUR_SECRET_KEY"
```
